...
import 'package:voleep_carclean_frontend/modules/product/presentation/product_form/situation_switch_controller.dart';
...
class ProductFormPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final productModel = ref.watch(productFormControllerProvider(productId, mode));
    ...
    return Scaffold(
      ...
      floatingActionButton: productModel.whenOrNull(
        data: (value) => FloatingActionButton.extended(
          onPressed: () async {
            if (_formKey.currentState!.validate()) {
              ...
              final pcCommission =
                  _pcComissionControl.text.isNotEmpty ? double.parse(doubleRE.firstMatch(_pcComissionControl.text)!.group(0)!) : null;
