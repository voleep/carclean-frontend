...
import 'package:voleep_carclean_frontend/shared/search_form/presentation/carclean_search_mobile.dart';
import 'package:voleep_carclean_frontend/shared/search_form/presentation/data_table/data_pagination_view.dart';
import 'package:voleep_carclean_frontend/shared/search_form/presentation/data_table/data_table_view.dart';
                          ...
                          children: [
                            ...
                            Consumer(
                              builder: (context, ref, child) {
                                ...
                                return Visibility(
                                  child: Row(
                                    children: actions.map((action) => IconButton(onPressed: action.onTap, icon: Icon(action.icon))).toList(),
                                  ),
                                );
                              },
                            )
                                  ...
                                  children: [
                                    ...
                                    DataPaginationView(
                                      ...
                                      onPageChanged: (page) {
                                        ...
                                        ref.read(searchControllerProvider(config).notifier).search(queryList ?? [], page);
                                      },
                                    )
                                  ],
                                ),
