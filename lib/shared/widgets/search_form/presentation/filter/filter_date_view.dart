...
class FilterDateView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final queryDateList = ref.watch(filterQueryProvider(config)
      ...
      children: [
        ..._checkboxDateList.asMap().entries.map((entry) {
          ...
          final currentQuery = queryDateList.firstWhereOrNull(
            (element) =>
                element.valueLabel ==
                _getDateLabelByValue(value: _getValueByDate(filterDate), finalValue: _getFinalValueByDate(filterDate)),
          );
                ...
                ref.read(filterQueryProvider(config).notifier).add(
                      FilterQueryState(
                        ...
                        valueLabel: _getDateLabelByValue(
                            value: _getValueByDate(filterDate), finalValue: _getFinalValueByDate(filterDate)),
                ...
                if (selectedDate != null) {
                  ...
                  ref.read(filterQueryProvider(config).notifier).add(
                        FilterQueryState(
                          ...
                          finalValue:
                              DateTime(dayAfterSelected.year, dayAfterSelected.month, dayAfterSelected.day).toString(),
                        ),
                      );
                }
              },
                ...
                if (selectedDate != null) {
                  ...
                  ref.read(filterQueryProvider(config).notifier).add(
                        FilterQueryState(
                          ...
                          value: DateTime(selectedDate.start.year, selectedDate.start.month, selectedDate.start.day)
                              .toString(),
